...
public class Helper {
    ...
    public static String getEmailOfLoggedInUser(Authentication authentication) {
        ...
        // if we have logged in sing email and username how will we get email that logic
        // is here
        if (authentication instanceof OAuth2AuthenticationToken) {
            ...
            System.out.println("Getting data from local databse.");
